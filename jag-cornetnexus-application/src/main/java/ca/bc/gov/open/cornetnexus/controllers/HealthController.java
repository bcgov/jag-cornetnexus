...
import ca.bc.gov.open.cornetnexus.one.GetHealth;
import ca.bc.gov.open.cornetnexus.one.GetHealthResponse;
import ca.bc.gov.open.cornetnexus.one.GetPing;
import ca.bc.gov.open.cornetnexus.one.GetPingResponse;
